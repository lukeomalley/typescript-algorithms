 ...
 * Merge Linked Lists
 *
 * Write a function that takes in the heads of two Single Linked Lists that are in sorted
 ...
 * Space:
 */
function mergeLinkedLists(args: any): any {
  // Write solution here
}
...
console.log(mergeLinkedLists(''));
evalFunctionPerformance(mergeLinkedLists, '');
